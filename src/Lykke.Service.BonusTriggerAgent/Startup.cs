...
namespace Lykke.Service.BonusTriggerAgent
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "BonusTriggerAgent API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "BonusTriggerAgentLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.BonusTriggerAgentService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("BonusTriggerAgent", channelOptions =>
                        {
