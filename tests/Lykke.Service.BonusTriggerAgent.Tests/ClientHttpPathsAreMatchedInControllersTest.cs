...
using Lykke.Service.BonusTriggerAgent;
using Lykke.Service.BonusTriggerAgent.Client;
using Microsoft.AspNetCore.Mvc;
using Refit;
using Xunit;

namespace Lykke.Service.BonusTriggerAgent.Tests
{
    public class ClientHttpPathsAreMatchedInControllersTest
    {
        ...
        {
            var clientInterface = typeof(IBonusTriggerAgentClient);
